...
import { ActionButton, Card, Chip, Page, PageHeader, textStyles } from '../shared/ui';
...
function ReviewEntry({ testID, title, summary, detail, actionLabel }: {
  testID: string;
  title: string;
  summary: string;
  detail?: string;
  ...
  return (
    <Card accent="review" testID={testID} style={styles.entryCard}>
      ...
      <View style={styles.actionRow}>
        <ActionButton label={actionLabel} variant="purple" disabled onPress={unavailableAction} />
      </View>
    </Card>
  );
}
