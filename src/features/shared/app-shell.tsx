    ...
    <ShellContext.Provider value={contextValue}>
      ...
      <Modal visible={settingsOpen} transparent animationType="fade" onRequestClose={() => setSettingsOpen(false)}>
        <Pressable style={styles.overlay} onPress={() => setSettingsOpen(false)}>
          <Pressable style={styles.modalCard} onPress={(event) => event.stopPropagation()}>
            <View style={styles.modalHeader}><View><Text style={styles.modalTitle}>Reflow 设置</Text><Text style={textStyles.meta}>v4 · 本地优先时间规划</Text></View><Pressable accessibilityRole="button" accessibilityLabel="关闭" onPress={() => setSettingsOpen(false)} style={styles.close}><Text>×</Text></Pressable></View>
